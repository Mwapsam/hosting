...
<div id="wrapper_fixed">
	...
	<div id="header_top">
		...
		<div id="header_phone">
			 Have questions? Call now!<span class="small">(ID:<?php echo $GLOBALS['rp_info']['store_id'];?>)</span><span class="number">+<?php if (function_exists('rp_support_phone')) echo substr(rp_support_phone(), 1); ?></span>
		</div>
...
<?php } ?>
			<div class="header-wrapper<?php if (has_custom_logo()) echo ' hide-for-small'?>">
