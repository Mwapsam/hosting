...
<div id="default_content" <?php if(isset($left_menu) && $left_menu) echo 'class="rpwp_content_with_left_menu"'?>>
  ...
  <div id="aboutus-content-main">
    ...
    <br/>
    <picture>
      <source srcset="<?php bloginfo( 'template_url' ); ?>/images/404-img.webp" type="image/webp"> 
      <img src="<?php bloginfo( 'template_url' ); ?>/images/404-img.png" width="252" height="258" alt="Error 404: Page Not Found!" title="Error 404: Page Not Found!" style="float:left; margin-right:40px;" />
    </picture>
