...
?>
	...
	<div id="footer">
      ...
      <?php if(is_active_nav_menu('footer1')){?>
        <h3><?php echo wp_nav_menu_title('footer1');?></h3>
      ...
      <?php if(is_active_nav_menu('footer2')){?>
        <h3><?php echo wp_nav_menu_title('footer2');?></h3>
      ...
      <?php if(is_active_nav_menu('footer3')){?>
        <h3><?php echo wp_nav_menu_title('footer3');?></h3>
      ...
      <?php }?>
		...
		<div id="footer_menu">
		  <?php if(is_active_nav_menu('footer4')){?>
			<h3><?php echo wp_nav_menu_title('footer4');?></h3>
    ...
    <div id="footer_contacts">
      ...
      <span><a href="mailto:<?php echo $GLOBALS['rp_info']['reseller_email']?>"><?php echo $GLOBALS['rp_info']['reseller_email']?></a></span>
    </div>
		<div id="footer_cards"></div>
		<div id="copyright"><?php if(!empty($rpwp_copyright_text)) echo stripslashes($rpwp_copyright_text); else{?> Copyright &copy; <?php echo $GLOBALS['rp_info']['store_title']?> 2004 - <?php echo date('Y')?>. All Rights Reserved!<?php }?></div>
	</div>
	</div><!-- content -->
</div><!-- wrapper_fixed -->
<?php
