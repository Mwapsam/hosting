<div id="home-banner-1">
    ...
    <div id="home-banner-1-video">
        <div id="fvideo1" style="width:530px; height:330px; cursor:pointer; background-image:url(<?php bloginfo('template_directory'); ?>/images/video.png);" data-video-src="<?php echo $video_url.$movie?>">&nbsp;</div>
    </div>
...
<?php } else if ($banner_plan[$plan]['type'] == 'vps_kvm') { ?>
	...
	<div class="novideo hide-for-small"><img src="<?php bloginfo('template_directory'); ?>/images/kvm-banner.png" alt="KVM VPS" title="KVM VPS"></div>
    <div class="home-banner-1-price">
   <?php if (!empty(rp_store_promos($banner_plan[$plan]['value']['rp_product_id']))) { 
        $promo = rp_store_promos($banner_plan[$plan]['value']['rp_product_id']);
    ?>
