<div id="home-banner-1">
	...
	<div id="home-banner-1-plan-features2">
        <ul>
            <li><span>Full</span> Root access</li>
            <li><span>24/7/365</span> Support</li>
            <li><span>NO</span> Setup Fees</li>
        </ul>
    </div>
	...
	<div id="home-banner-1-plan-features2">
        <ul>
            <li><span>30</span> Day Money-Back</li>
            <li><span>24/7/365</span> Support</li>
	...
	<div id="home-banner-1-plan-features2">
        <ul>
            <li><span>99.9%</span> Network Uptime</li>
            <li><span>24/7/365</span> Support</li>
            <li><span>NO</span> Setup Fees</li>
        </ul>
    </div>
   ...
   <?php if (!empty(rp_store_promos($banner_plan[$plan]['value']['rp_product_id']))) { 
    ...
    ?>
                <span class="currency"><?php echo _rp_get_currency_symbol($banner_plan[$plan]['value']['store_currency']);?></span><span class="price-value"><?php echo $promo['price_promo']; ?></span> <span class="currency">/mo*</span>
    <?php } else { ?>
                <span class="currency"><?php echo _rp_get_currency_symbol($banner_plan[$plan]['value']['store_currency']);?></span><span class="price-value"><?php echo sprintf('%0.2f',$banner_plan[$plan]['value']['prices']['period_1'][$banner_plan[$plan]['value']['store_currency']]); ?></span>/mo
    <?php } ?>
    </div>
...
<?php } ?>
   <?php if (!empty(rp_store_promos($banner_plan[$plan]['value']['rp_product_id']))) { 
        $promo = rp_store_promos($banner_plan[$plan]['value']['rp_product_id']);
    ?>
		<div class="promo-period-text">* for<?php if ($banner_plan[$plan]['type'] != 'dedicated') { ?> the first<?php } ?> <?=$promo['period_promo']?> mо/(s), renews at - <?php echo _rp_get_currency_symbol($banner_plan[$plan]['value']['store_currency']);?><?php echo $promo['price_normal']; ?></div>
    <?php } ?>
    </div>
