<?php
$box_classes = array('first','second','third','fourth','fifth','sixth');
	...
	<?php } ?>
					...
					<div id="box-content">
						...
						<ul>
							...
							<li><?php if(!empty($plan['free_domains'])){ ?>FREE Domain Name<?php }else{ ?>1-Click 40+ Scripts Installer<?php } ?></li>
						</ul>
						<ul>
