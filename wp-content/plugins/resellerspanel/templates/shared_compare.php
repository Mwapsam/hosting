    ...
    <?php foreach($rp_plans as $key=>$plan) : ?>
      <td><div id="tower-box">
          ...
          <div id="tower-box-content">
            <ul>
              <li>
                <div id="tower-box-price"> <span class="tower-box-price-currency"><?php echo _rp_get_currency_symbol($plan['store_currency']);?></span> <span class="tower-box-price-value"><?php echo sprintf('%0.2f',$plan['prices']['period_1'][$plan['store_currency']]); ?></span> <span class="tower-box-price-period">/mo</span> </div>
              </li>
